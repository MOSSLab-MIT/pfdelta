...
class PFDeltaDataset(InMemoryDataset):
    def __init__(self, root_dir='data', case_name='', transform=None, pre_transform=None, pre_filter=None, force_reload=False):
        self.root = root_dir
    ...
    @property
    def raw_dir(self):
        return os.path.join(self.root, self.case_name, "nose") # how did we do this in main?
    ...
    def build_heterodata(self, pm_case: dict):
        ...
        feasibility = True # get rid of this later. Maybe have all checks happen elsewhere.
